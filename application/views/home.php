<div class="main-content" style="margin-top:-440px;">
                ...
                <div class="card-stats">
                  <div class="card-stats-title">Perubahan Stastistic - 
                    <div class="dropdown d-inline">
                      <a class="font-weight-600 dropdown-toggle" data-toggle="dropdown" href="#" id="orders-month">Mapping</a>
                      <ul class="dropdown-menu dropdown-menu-sm">
                        <li class="dropdown-title">Pilih map</li>
                        <li><a href="<?= base_url('home/pemetaan_tps') ?>" class="dropdown-item">Map</a></li>
                  ...
                  <div class="card-stats-items">
                    <div class="card-stats-item">
                      ...
                      <div class="card-stats-item-label text-primary">Sukabumi</div>
                    </div>
                    <div class="card-stats-item">
                      <div class="card-stats-item-count">12</div>
                      <div class="card-stats-item-label text-primary">Bandung</div>
                    </div>
                    <div class="card-stats-item">
                      <div class="card-stats-item-count">23</div>
                      <div class="card-stats-item-label">Jakarta</div>
                    </div>
                  </div>
                </div>
        ...
        L.tileLayer(
            'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
                attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
                    '<a href="https://creativecommons.org/licenses/by-sa/2.0/">Dinas</a>, ' +
                    'Imagery © <a href="https://www.bappedasukabumi.com">Bappeda</a>',
        ...
        L.marker([-6.988209, 106.550405], {icon: icon1}).addTo(map);
                  ...
                  <ul class="list-unstyled list-unstyled-border">
                    ...
                    <?php foreach($tps as $key){?>
                      ...
                      <div class="media-body">
                        ...
                        <div class="media-title"><?= $key['kecamatan'] ?></div>
                        <?php } ?>
                        <div class="mt-1">
                  ...
                  <div class="owl-carousel owl-theme" id="products-carousel">
                    <div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="<?= base_url() ?>template/assets/img/products/product-4-50.png" class="img-fluid">
                        </div>
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="<?= base_url() ?>template/assets/img/products/product-3-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="<?= base_url() ?>template/assets/img/products/product-1-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= base_url() ?>template/assets/modules/flag-icon-css/flags/4x3/id.svg" alt="image" width="40">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= base_url() ?>template/assets/modules/flag-icon-css/flags/4x3/my.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= base_url() ?>template/assets/modules/flag-icon-css/flags/4x3/us.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                    ...
                    <div class="col-sm-6 mt-sm-0 mt-4">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= base_url() ?>template/assets/modules/flag-icon-css/flags/4x3/ps.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= base_url() ?>template/assets/modules/flag-icon-css/flags/4x3/de.svg" alt="image" width="40">
                          <div class="media-body ml-3">
