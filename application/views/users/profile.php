<div class="main-content" style="margin-top:-70px;">
    <div class="card mb-3" style="max-width: 540px;">
        ...
        <button type="submit" class="btn btn-outline-primary" data-toggle="modal" data-target="#newMenuModal" onclick="add()" style="color:red; float: right;">
            Lengkapi Data
        </button>
        <?php echo form_open_multipart('home/input_data'); ?>
        <div class="form-group">
            <label for="nama_sekolah">NPSN</label>
            <input style="width: 100%;" minlength="8" maxlength="8" type="text" value="" name="nama_sekolah" class="form-control" required="" placeholder="83212212" id="demo">
        </div>
        <div class="form-group">
            <label for="alamat">Nama Sekolah</label>
            <input type="text" value="" name="nama_sekolah" class="form-control" required="" placeholder="Bappeda" id="nama_sekolah">
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="latitude">Latitude</label>
                <input type="text" value="" name="latitude" class="form-control" required="" placeholder="-83212212" id="latitude">
            </div>
            <div class="form-group col-md-6">
                <label for="longitude">Longitude</label>
                <input type="text" value="" name="longitude" class="form-control" required="" placeholder="231122332" id="longitude">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="" name="alamat" class="form-control" required="" placeholder="Bappeda" id="alamat">
        </div>
        <div class="form-group">
            <label for="desa">Desa</label>
            <input type="text" value="" name="desa" class="form-control" required="" placeholder="Pelabuhanratu" id="desa">
        </div>
        <div class="form-row">
            <div class="form-group">
                <label for="kecamatan">Kecamatan</label>
                <input type="text" value="" name="kecamatan" class="form-control" required="" placeholder="Pelabuhanratu" id="kecamatan">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="jumlah_siswa">jumlah_siswa</label>
                <input type="text" value="" name="jumlah_siswa" class="form-control" required="" placeholder="200" id="jumlah_siswa">
            </div>
            <div class="form-group col-md-6">
                <label for="jumlah_guru">jumlah_guru</label>
                <input type="text" value="" name="jumlah_guru" class="form-control" required="" placeholder="0000" id="jumlah_guru">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group">
                <label for="kepala_sekolah">kepala_sekolah</label>
                <input type="text" value="" name="kepala_sekolah" class="form-control" required="" placeholder="Pelabuhanratu" id="kepala_sekolah">
            </div>
        </div>
