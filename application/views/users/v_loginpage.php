...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('template/images/bg-011.jpg');">
            <div class="wrap-login100">
                     <form class="login100-form validate-form" method="POST" action="<?= base_url('home/Login'); ?>">
                    
                    <span class="login100-form-logo">
                        <img src='template/images/logo.png' height="120">
                    </span>
                    ...
                    <div class="text-center p-t-90">
                        <a class="txt1" href="<?= base_url('home/register1') ?>">
                            Belum Daftar?
                        </a>
                    </div>
                </form>
