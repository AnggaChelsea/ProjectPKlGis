            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="<?= base_url('home/index') ?>"> <h4 class="text-warning">MAP SCHOOL</h4> <!-- <img src="<?= base_url() ?>template3/img/logo.png" alt="logo"> --> </a>
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        ...
                        <a href="<?= base_url()?>template3/#" class="btn_1">Read More</a>
                    </div>
                </div>
           ...
           <div class="row align-items-sm-center align-items-xl-stretch">
               <div class="col-md-6 col-lg-6">
                   <div class="learning_member_text">
                       ...
                       <h2><span class="text-warning">Map School</span> Sistem Pemetaan Sekolah</h2>
                       <p>Sistem ini bertujuan untuk memudahkan penduduk yang baru / pendatang mengetahui titik lokasi suatu sekolah meskipun di daerah terpencil 
                           Terkusus Daerah Kabupaten Sukabumi, </p>
                       <div class="row">
                           ...
                           <div class="col-sm-6 col-md-12 col-lg-6">
                               <div class="learning_member_text_iner">
                                   ...
                                   <p>Pemetaan lokasi Sekolah di Map School ini di utamakan sekolah yang butuh bantuan dan perlu Sekolahnya di aktipkan dan di tingkatkan kembali</p>
                               </div>
                           </div>
                       </div>
                   </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="<?= base_url()?>template3/https://colorlib.com" target="_blank">Colorlib</a>
