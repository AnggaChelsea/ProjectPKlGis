...
class Send_email extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $config = [
      ...
      'smtp_user' => 'KampungKetupat',  // Email gmail
      'smtp_pass'   => 'Sayangmamah1.',  // Password gmail
      'smtp_crypto' => 'ssl',
      'smtp_port'   => 587,
      'crlf'    => "\r\n",
      'newline' => "\r\n"
    ...
    $this->email->from('kampungketupat41@gmail.com', 'MasRud.com');

    // Email penerima
    $this->email->to('freelancerw9@gmail.com'); // Ganti dengan email tujuan
